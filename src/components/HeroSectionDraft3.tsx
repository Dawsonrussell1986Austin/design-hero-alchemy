...
const HeroSectionDraft3 = () => {
  return (
    <div className="relative z-20 min-h-[60vh] md:min-h-[70vh] lg:min-h-[75vh] xl:min-h-[80vh] px-4 sm:px-6 pt-28 sm:pt-28 md:pt-32 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-1 sm:space-y-2">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-medium text-cream leading-[0.9] tracking-tight opacity-0 animate-[slideUp_0.8s_ease-out_0.2s_forwards]">
                Where Strength
              </h1>
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-medium leading-[0.9] tracking-tight opacity-0 animate-[slideUp_0.8s_ease-out_0.6s_forwards]">
                <span className="text-cream">Stewardship.</span>
              </h1>
            </div>
            
            <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-cream/80 max-w-lg leading-relaxed font-body font-normal opacity-0 animate-[fadeInUp_0.8s_ease-out_0.8s_forwards] mobile-text-scale">
            ...
            {/* CTA Buttons - Gold accent */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 opacity-0 animate-[fadeInUp_0.8s_ease-out_1s_forwards]">
              <Link to="/lending">
                <Button 
                  size="lg" 
                  className="bg-gold-accent hover:bg-gold-warm text-abyss px-8 py-3 text-base font-body font-medium tracking-wide transition-all duration-300 rounded-sm hover:scale-105 hover:shadow-lg hover:shadow-gold-accent/20"
                >
                  Borrowers
              ...
              <Link to="/whyoak">
                <Button 
                  size="lg" 
                  variant="outline"
                  className="border-2 border-cream bg-cream/10 text-cream hover:bg-cream hover:text-abyss px-8 py-3 text-base font-body font-medium tracking-wide transition-all duration-300 rounded-sm backdrop-blur-sm hover:scale-105 hover:shadow-lg hover:shadow-cream/20"
                >
                  Why Oak
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
          ...
          <div className="lg:col-span-2 mt-6">
            <p className="text-xs text-cream/60 font-sans text-center lg:text-left">
...
export default HeroSectionDraft3;
