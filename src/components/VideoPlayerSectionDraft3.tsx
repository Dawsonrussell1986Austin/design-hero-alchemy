...
const VideoPlayerSectionDraft3 = () => {
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-cream/80 text-lg font-body max-w-3xl mx-auto leading-relaxed">
              ...
              <div className="relative aspect-video">
                {!isPlaying && (
                  <div className="absolute inset-0 cursor-pointer group" onClick={() => setIsPlaying(true)}>
                    <img src={videoThumbnail} alt="Who is Oak Real Estate Partners" className="w-full h-full object-cover" />
                    <div className="absolute inset-0 bg-abyss/10 group-hover:bg-abyss/20 transition-colors flex items-center justify-center">
                ...
                {isPlaying && (
                  <wistia-player media-id="wn4w0z7jch" aspect="1.7777777777777777" className="w-full h-full" />
                )}
              </div>
            </div>
          ...
          <div className="text-center mt-12">
            <p className="text-cream/70 text-sm font-body max-w-2xl mx-auto italic">
...
export default VideoPlayerSectionDraft3;
