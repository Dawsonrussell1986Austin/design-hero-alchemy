...
const HeroSection = () => {
  return (
    <div className="relative z-20 min-h-screen px-4 sm:px-6 lg:px-8 pt-32 sm:pt-40 md:pt-44 lg:pt-48 pb-16 sm:pb-24 overflow-hidden mobile-nav-safe flex flex-col items-center justify-start lg:justify-center">
