...
const HeroSection = () => {
  return (
    <div className="relative z-20 min-h-[60vh] md:min-h-[70vh] lg:min-h-[75vh] xl:min-h-[80vh] px-4 sm:px-6 pt-36 sm:pt-24 md:pt-32 pb-16 sm:pb-20 overflow-hidden mobile-nav-safe">
