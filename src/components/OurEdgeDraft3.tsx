        ...
        <div className="bg-abyss flex items-center py-12 lg:py-20">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-2xl">
              <h2 className="text-4xl lg:text-5xl font-display font-medium text-cream mb-12">
                Our Edge
              </h2>
              
              <p className="text-xl lg:text-2xl leading-relaxed font-body text-cream/90 mb-16">
              ...
              <div className="space-y-8">
                <div className="border-l-4 border-gold-accent pl-6">
                  ...
                  <p className="text-cream/80 font-body">$18B+ in closed transactions over the past three decades</p>
                </div>
                
                <div className="border-l-4 border-gold-accent pl-6">
                  <div className="text-lg font-display font-medium text-gold-accent mb-2">Deep Expertise</div>
                  <p className="text-cream/80 font-body">Institutional underwriting coupled with deep market expertise</p>
                </div>
                
                <div className="border-l-4 border-gold-accent pl-6">
                  <div className="text-lg font-display font-medium text-gold-accent mb-2">Flexible Solutions</div>
                  <p className="text-cream/80 font-body">Flexible capital structures including debt and equity for real estate sponsors</p>
                </div>
              </div>
            </div>
          </div>
