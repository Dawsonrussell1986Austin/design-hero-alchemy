...
const Navigation = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      scrolled 
        ? 'bg-silver-mist/95 backdrop-blur-xl border-b border-abyss/10 shadow-lg' 
        : 'bg-silver-mist/90 backdrop-blur-sm border-b border-abyss/5'
    }`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-12">
            <div className="group relative">
              <button className={`flex items-center transition-all duration-300 font-body font-medium text-sm tracking-wide ${
                scrolled ? 'text-abyss hover:text-garnet-edge' : 'text-abyss hover:text-garnet-edge'
              }`}>
                Our Firm
              ...
              <div className={`absolute left-0 top-full w-48 border rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 ${
                scrolled ? 'bg-silver-mist border-abyss/10' : 'bg-silver-mist border-abyss/10'
              }`}>
                <div className="py-2">
                  <a 
                    href="/about" 
                    className={`block px-4 py-2 text-sm transition-colors duration-200 ${
                      scrolled ? 'text-abyss hover:bg-garnet-edge/20 hover:text-garnet-edge' : 'text-abyss hover:bg-garnet-edge/20 hover:text-garnet-edge'
                    }`}
                  >
                    About Us
                  </a>
          ...
          <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
            <SheetTrigger asChild>
              <Button
                ...
                className={`lg:hidden rounded-none p-2 ${
                  scrolled ? 'text-abyss hover:bg-silver-mist' : 'text-abyss hover:bg-silver-mist'
                }`}
              >
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[380px] bg-abyss border-l border-garnet-edge/20 p-0 mobile-nav-safe">
