  ...
  return (
    <Card className="bg-white/20 backdrop-blur-md border border-white/30 overflow-hidden hover:border-accent-brown/50 hover:shadow-xl hover:bg-white/30 transition-all duration-300 group shadow-lg">
      ...
      <CardContent className="p-6 bg-white/10 backdrop-blur-sm border-t border-white/20">
        <h3 className="text-lg font-semibold text-obsidian mb-4 leading-tight border-b border-white/20 pb-3">
          {transaction.name}
        </h3>
        
        <div className="space-y-3">
          <div className="text-deep-petrol text-sm font-medium border-b border-white/20 pb-2">
            {transaction.location}
          </div>
          
          <div className="text-accent-brown text-xl font-bold border-b border-white/20 pb-2">
