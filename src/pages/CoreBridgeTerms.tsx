            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start mb-12">
              ...
              <div className="space-y-6">
                <div className="bg-obsidian text-center p-8 rounded-lg">
                  ...
                  <p className="text-silver-mist/80 mb-6">Loan Type: Bridge Loans</p>
                  <Button 
                ...
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-6">
                  ...
                  <div className="space-y-2">
                    <a href="/lending/bridge/core-bridge" className="block text-garnet-edge font-medium">Core Bridge</a>
