  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "linear-gradient(135deg, #060D14, #082233, #233F52)" }}>
      <SEOHead
        ...
        description="Request the Investor Report from Oak Real Estate Partners."
        canonicalUrl="/investor-report"
        noIndex
      />
...
export default InvestorReportForm;
