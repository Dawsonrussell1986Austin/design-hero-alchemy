  ...
  const blogPosts = [
    {
      ...
      excerpt: "In today's commercial real estate market, many investors hear a lot of noise about private equity, distressed assets, and market dislocation. What often gets lost is a simpler truth: some of the most compelling opportunities aren't distressed at all — they're just in transition.",
      date: "January 7, 2026",
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        ...
        description="Expert insights on commercial real estate lending, private equity strategies, and market trends from Oak Real Estate Partners. Articles on bridge loans, HUD financing, and investment opportunities."
        canonicalUrl="/blog"
      />
      <OrganizationSchema />
      <BreadcrumbSchema
