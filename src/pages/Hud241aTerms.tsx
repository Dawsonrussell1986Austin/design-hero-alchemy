              ...
              <div>
                ...
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-6 shadow-lg mb-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-garnet-edge rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-sm text-obsidian/80 leading-relaxed">Your property has an existing HUD-insured first mortgage</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-garnet-edge rounded-full mt-2 flex-shrink-0"></div>
                ...
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-6 shadow-lg">
                  ...
                  <p className="text-sm text-obsidian/80 leading-relaxed">
                    Red Oak's expertise in HUD programs ensures streamlined processing and competitive terms for your supplemental financing needs.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <a href="/lending/fha-hud/hud-241a" className="block text-garnet-edge font-medium text-sm">HUD 241(a)</a>
                    
                    <p className="text-sm font-medium text-obsidian/80 mt-4">Senior Housing & Healthcare</p>
                    <a href="/lending/fha-hud/hud-232-221" className="block text-obsidian/70 hover:text-garnet-edge transition-colors text-sm">232/221(d)4</a>
                ...
                <table className="w-full">
                  <tbody className="divide-y divide-obsidian/10">
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-6 text-sm text-obsidian/80">Fixed for the term of the loan and determined at time of rate lock.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-6 text-sm text-obsidian/80">Negotiable; 0-1 Year lockout, with a declining 1% per year penalty, open after year 10 with no yield maintenance or defeasance. Depending on market conditions, other pre-payment options are available.</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6 text-sm font-medium text-obsidian bg-obsidian/5">Third Party Reports</td>
                      <td className="py-4 px-6 text-sm text-obsidian/80">Market Study, Appraisal, Environmental Report and PCNA or AEC Review (as applicable - if major building changes are made to the project).</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6 text-sm font-medium text-obsidian bg-obsidian/5">Escrows</td>
                      <td className="py-4 px-6 text-sm text-obsidian/80">The supplemental loan will not require a second reserve escrow. However, it will require a new analysis of the existing reserves for replacement in place for the first FHA-insured mortgage. This new CNA assessment will determine the needs for the existing project along with any new additions from the supplemental loan.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-6 text-sm text-obsidian/80">$3 per $1,000 of the requested mortgage (1/2 required at Pre-Application) or $2 per $1,000 for OZ.</td>
                    </tr>
                    <tr>
