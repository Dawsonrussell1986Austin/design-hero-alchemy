              ...
              <div>
                ...
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-6 shadow-lg">
                  ...
                  <p className="text-sm text-obsidian/80 leading-relaxed">
                    Red Oak's proven track record in healthcare facility financing ensures competitive rates and expert guidance through the HUD 232/223(f) process.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <a href="/lending/fha-hud/hud-232-223f" className="block text-garnet-edge font-medium text-sm">232/223 (f)</a>
                ...
                <table className="w-full">
                  <tbody className="divide-y divide-obsidian/10">
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-6 text-sm text-obsidian/80">Cash or a letter of credit for up to 20% of the estimated cost of repairs.</td>
                    </tr>
                    <tr>
