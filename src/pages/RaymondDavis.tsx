  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-abyss via-obsidian to-graphite-fog">
      <SEOHead
        ...
        canonicalUrl="/leadership/raymond-davis"
      />
      {/* Navigation */}
      <Navigation />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="lg:col-span-2 space-y-6">
                <div>
                  <h1 className="text-3xl lg:text-4xl font-light text-gold-accent mb-3">Raymond T. Davis</h1>
                  ...
                  <div className="flex space-x-3">
                    <Button
                      ...
                      onClick={() => window.location.href = 'mailto:rdavis@oakrepartners.com'}
                    >
                    ...
                    <Button
                      ...
                      size="sm"
                      className="text-garnet-edge hover:text-silver-mist hover:bg-garnet-edge/20 p-2"
                      onClick={() => window.open("https://www.linkedin.com/in/raymondtdavis/", "_blank")}
                    >
