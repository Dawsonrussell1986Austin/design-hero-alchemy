...
const MarketCorrection = () => {
  ...
  // Load Cormorant Garamond + Manrope (matching the ad design system)
  useEffect(() => {
    const link = document.createElement("link");
    link.href = "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,600;0,700;1,300;1,400;1,600;1,700&family=Manrope:wght@200;300;400;500;600;700&display=swap";
    link.rel = "stylesheet";
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#07090f" }}>
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-24 lg:py-36" style={{ backgroundColor: "#07090f" }}>
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-xl sm:text-2xl lg:text-3xl leading-[1.3] font-light" style={{ ...serif, color: "rgba(255,255,255,0.85)", fontStyle: "italic" }}>
            If a correction arrives in the next 90 days, does your portfolio hold?
          </p>
          <p className="text-xl sm:text-2xl lg:text-3xl leading-[1.3] mt-2 font-light" style={{ ...serif, color: "#dbb96a", fontStyle: "italic" }}>
