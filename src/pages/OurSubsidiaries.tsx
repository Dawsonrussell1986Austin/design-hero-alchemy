          ...
          <div className="container mx-auto px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              ...
              <section className="mb-16">
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-8 shadow-lg mb-12">
                  ...
                  <div className="bg-silver-mist/30 rounded-lg p-6">
                    <h3 className="text-xl font-bold text-obsidian mb-6 text-center">Leadership Team</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
                      <div className="text-center">
                        <div className="bg-white rounded-lg p-6 hover:shadow-md transition-all duration-300 border border-silver-mist">
                          ...
                          <p className="text-sm text-deep-petrol mb-4">SVP/CHIEF UNDERWRITER<br/>MAP AND LEAN PROGRAMS</p>
                        </div>
                      </div>
              ...
              <section className="mb-16">
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-8 shadow-lg">
                  <div className="text-center mb-8">
