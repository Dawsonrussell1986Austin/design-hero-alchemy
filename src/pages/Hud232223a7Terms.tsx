              ...
              <div>
                ...
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-6 shadow-lg">
                  ...
                  <p className="text-sm text-obsidian/80 leading-relaxed">
                    Red Oak's deep expertise in HUD healthcare refinancing ensures competitive rates and streamlined processing for your 232/223(a)(7) loan.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white/60 backdrop-blur-sm border border-obsidian/20 rounded-lg p-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <a href="/lending/fha-hud/hud-232-223a7" className="block text-garnet-edge font-medium text-sm">232/223(a)(7)</a>
