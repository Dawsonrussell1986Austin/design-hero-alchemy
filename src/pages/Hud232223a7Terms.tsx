                ...
                <div className="bg-cream/60 backdrop-blur-sm border border-abyss/20 rounded-lg p-6 shadow-lg mb-8">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <p className="text-sm text-abyss/80 leading-relaxed">You want to refinance an existing HUD-insured healthcare facility</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-garnet-edge rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-sm text-abyss/80 leading-relaxed">Your facility is already under HUD's Mortgage Insurance Program</p>
                    </div>
                    <div className="flex items-start space-x-3">
                      <div className="w-2 h-2 bg-garnet-edge rounded-full mt-2 flex-shrink-0"></div>
                      <p className="text-sm text-abyss/80 leading-relaxed">You need long-term, fixed-rate financing for your healthcare property</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <table className="w-full">
                  <tbody className="divide-y divide-abyss/10">
                    <tr>
                      ...
                      <td className="py-4 px-6 text-sm text-abyss/80">Refinance of an existing Nursing Home, Intermediate Care Facility, Board & Care Home or Assisted Living Facility.</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6 text-sm font-medium text-abyss bg-abyss/5">Eligible Properties</td>
                      <td className="py-4 px-6 text-sm text-abyss/80">The facility must already be insured under HUD's Mortgage Insurance Program.</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6 text-sm font-medium text-abyss bg-abyss/5">Commercial Space</td>
                      <td className="py-4 px-6 text-sm text-abyss/80">Eligible for up to 20% of total square footage and 20% of EGI. Commercial Space that is intended to exclusively serve the residents of the project is not counted toward the 20 percent limit</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="py-4 px-6 text-sm text-abyss/80">Cash or a letter of credit for up to 10% of the estimated cost of non-critical repairs.</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6 text-sm font-medium text-abyss bg-abyss/5">HUD Application Fee</td>
                      <td className="py-4 px-6 text-sm text-abyss/80">$1.50 per $1,000 of requested mortgage.</td>
                    </tr>
                    <tr>
                      <td className="py-4 px-6 text-sm font-medium text-abyss bg-abyss/5">HUD Inspection Fee</td>
                      <td className="py-4 px-6 text-sm text-abyss/80">No Inspection Fee</td>
                    </tr>
                    <tr>
