                ...
                <table className="w-full">
                  <tbody className="space-y-1">
                    ...
                    <tr className="border-b border-obsidian/10">
                      ...
                      <td className="py-4 text-obsidian/80 pl-4">$2 Million to $30 Million+</td>
                    </tr>
                    <tr className="border-b border-obsidian/10">
                    ...
                    <tr className="border-b border-obsidian/10">
                      ...
                      <td className="py-4 text-obsidian/80 pl-4">Up to 90% LTV (based on stabilized value)<br/>Up to 100% LTC (based on transaction underwriting)</td>
                    </tr>
                    <tr className="border-b border-obsidian/10">
                      <td className="py-4 pr-8 font-semibold text-obsidian bg-silver-mist/50 pl-4">Interest Rate</td>
                      <td className="py-4 text-obsidian/80 pl-4">1-Month Term SOFR plus 700BPs (interest-only)</td>
                    </tr>
                    <tr className="border-b border-obsidian/10">
                    ...
                    <tr className="border-b border-obsidian/10">
                      <td className="py-4 pr-8 font-semibold text-obsidian bg-silver-mist/50 pl-4">Floor Cap / Rate Cap</td>
                    ...
                    <tr className="border-b border-obsidian/10">
                      <td className="py-4 pr-8 font-semibold text-obsidian bg-silver-mist/50 pl-4">Exit Fees</td>
                      <td className="py-4 text-obsidian/80 pl-4">15% to 25% participation in value creation (based on specific transaction) subject to returns</td>
                    </tr>
                    <tr className="border-b border-obsidian/10">
                    ...
                    <tr className="border-b border-obsidian/10">
                      ...
                      <td className="py-4 text-obsidian/80 pl-4">Future funding facility toward tenant improvements, leasing commissions and rehabilitation costs</td>
                    </tr>
                    <tr>
