    ...
    <div className="min-h-screen bg-gradient-to-br from-warm-cream via-silver-mist to-warm-cream">
      ...
      <section className="container mx-auto px-6 pb-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white/60 backdrop-blur-sm p-6 rounded-lg border border-accent-brown/20">
              <h3 className="text-lg font-semibold text-charcoal-blue mb-3">
      ...
      <section className="container mx-auto px-6 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white/60 backdrop-blur-sm p-8 rounded-lg border border-accent-brown/20">
            <p className="text-lg text-charcoal-blue/80 leading-relaxed">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-accent-brown/20 bg-accent-brown/5">
                    <td className="p-4 font-semibold text-charcoal-blue">Opportunistic Bridge</td>
                    <td className="p-4 text-charcoal-blue/80 font-medium">High-LTC loans with embedded equity component for value-add strategies</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-medium text-charcoal-blue">Participating Bridge</td>
                    <td className="p-4 text-charcoal-blue/80">Flexible loans with equity participation aligned to sponsor performance</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-accent-brown/20">
                    ...
                    <td className="p-4 text-charcoal-blue/80">Acquisition, Refinance, Conversion, Rehabilitation, Stabilization</td>
                  </tr>
                  <tr className="border-b border-accent-brown/20">
                    <td className="p-4 font-medium text-charcoal-blue">Geography</td>
                    <td className="p-4 text-charcoal-blue/80">Primary, secondary, and select tertiary U.S. markets (min. pop. 50K–100K)</td>
                  </tr>
                  <tr className="border-b border-accent-brown/20">
                    <td className="p-4 font-medium text-charcoal-blue">Max LTV / LTC</td>
                    <td className="p-4 text-charcoal-blue/80">Up to 75% LTV (stabilized); Up to 90% LTC (underwritten)</td>
                  </tr>
                  <tr className="border-b border-accent-brown/20">
                    <td className="p-4 font-medium text-charcoal-blue">Interest Rate</td>
                    <td className="p-4 text-charcoal-blue/80">1-Month Term SOFR + 600 – 700 bps (Interest-Only)</td>
                  </tr>
                  <tr className="border-b border-accent-brown/20">
                  ...
                  <tr className="border-b border-accent-brown/20">
                    <td className="p-4 font-medium text-charcoal-blue">Fees</td>
                    <td className="p-4 text-charcoal-blue/80">Competitive origination and exit fees based on loan complexity</td>
                  </tr>
                  <tr className="border-b border-accent-brown/20">
                  ...
                  <tr className="border-b border-accent-brown/20">
                    ...
                    <td className="p-4 text-charcoal-blue/80">Full funding with customary holdbacks</td>
                  </tr>
                  <tr className="border-b border-accent-brown/20">
                    <td className="p-4 font-medium text-charcoal-blue">Recourse</td>
                    <td className="p-4 text-charcoal-blue/80">Typically non-recourse, with standard carve-outs</td>
                  </tr>
                  <tr className="border-b border-accent-brown/20">
                  ...
                  <tr className="border-b border-accent-brown/20">
                    ...
                    <td className="p-4 text-charcoal-blue/80">Available for TI/LC, conversion, and approved rehabilitation costs</td>
                  </tr>
                  <tr>
                    <td className="p-4 font-medium text-charcoal-blue">Deposits</td>
                    <td className="p-4 text-charcoal-blue/80">Sufficient to cover third-party reports, legal, and due diligence</td>
                  </tr>
                </tbody>
              </table>
            </div>
